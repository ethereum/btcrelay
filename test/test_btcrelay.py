...
class TestBtcRelay(object):
    ...
    def testStoreBlockHeader(self):
        ...
        # print('@@@ btcrelay addr: '+self.c.address)
        bal = self.c.coinBalanceOf(self.c.address)
        assert bal == 2**200
