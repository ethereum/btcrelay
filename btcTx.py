...
def test_getOutputScriptWithMultipleInputs():
    ...
    expHashOfOutputScript = 42535690015913681961856594885510831488508094798622685656746317591430791986005
...
def test_getOutput0Script():
    ...
    outNum = 0
    # exp hash is untested
    expHashOfOutputScript = 55646073396681106312728358789220060138590128840646868864033701002718115275327
    res = self.__checkOutputScript(rawTx, len(rawTx), outNum, expHashOfOutputScript)
    return(res)
...
def test_getOutput1Script():
    ...
    outNum = 1
    # exp hash is untested
    expHashOfOutputScript = 69176403543391051607780522012253476552193682861321342121735529633219950939982
    res = self.__checkOutputScript(rawTx, len(rawTx), outNum, expHashOfOutputScript)
    return(res)
